...
import {getArticlesByCategory} from "~/entities/category-news/model/api/getArticlesByCategory";
import type {Categories} from "~/entities/article";

const newsIncrement = 6

export const useNewsByCategoryCultureStore = create<NewsStore>((set, get) => ({
  newsList: [],
